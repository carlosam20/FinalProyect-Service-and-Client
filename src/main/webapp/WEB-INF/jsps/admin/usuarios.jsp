...
<div class="card mx-auto " style="width: 32rem;" >
    ...
    <li class="list-group-item">alta: ${usuario.alta}</li>
    </ul>
    
    <div class="card-body">
	<c:if test="${ usuario.alta == true}">
		 	<a  href="darBajaUsuario?id=${usuario.id}"class="card-link">dar de baja</a>
	</c:if>
	
	 <c:if test="${ usuario.alta == false}">
		 	<a href="darAltaUsuario?id=${usuario.id}" class="card-link">dar de alta</a>
	</c:if>
