...
<springform:form modelAttribute="nuevoPedido" action="guardarNuevoPedido" enctype="multipart/form-data">

nombre completo: <springform:input path="nombreCompleto"/><br><br>
